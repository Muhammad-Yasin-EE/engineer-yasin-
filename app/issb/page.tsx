        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[
              ...
              { title: "Armed Forces Equivalent Ranks", category: "Military GK", desc: "Comparative commissioning hierarchy across Pakistan Army, Navy, and Air Force for Deputy President interview orientation.", icon: Award, isReady: true, href: "/issb/ranks", bg: "bg-amber-50/60 border-amber-200/80 hover:border-amber-500", tag: "bg-amber-100 text-amber-900", iconStyle: "bg-amber-100 text-amber-700 group-hover:bg-amber-600" },
