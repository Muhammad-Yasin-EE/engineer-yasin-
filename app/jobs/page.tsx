...
export default function JobsPage() {
  const commissions = [
    ...
    { id: 'bpsc', name: 'Balochistan Public Service Commission', shortName: 'BPSC Quetta', desc: 'PMS Balochistan, Section Officers & Assistant Commissioners', cardBgUrl: '/images/card-bpsc.jpg', href: '/prep/public-service/bpsc', officialUrl: 'http://www.bpsc.gob.pk' },
