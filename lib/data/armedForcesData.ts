...
export const branchColors: Record<string, { primary: string; bg: string; badge: string; border: string }> = {
  ...
  css: { primary: '#2563eb', bg: 'bg-blue-50', badge: 'bg-blue-100 text-blue-800', border: 'border-blue-200' },
  fia: { primary: '#2563eb', bg: 'bg-blue-50', badge: 'bg-blue-100 text-blue-800', border: 'border-blue-200' },
}

export const branchImages: Record<string, string> = {
  army: '/images/pak_army_emblem.jpg',
  paf: '/images/pak_paf_emblem.jpg',
  navy: '/images/pak_navy_emblem.jpg',
}
