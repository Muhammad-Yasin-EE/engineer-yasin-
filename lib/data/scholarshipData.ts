...
export const internationalScholarships: ScholarshipItem[] = [
  ...
  },
  {
    ...
    image: '/images/card-gd-pilot.jpg',
    featured: true,
  ...
  },
  {
    ...
    image: '/images/card-aeronautical.jpg',
    featured: true,
  ...
  },
  {
    ...
    image: '/images/card-paf-admin.jpg',
    featured: true,
  ...
  },
  {
    ...
    image: '/images/card-paf-education.jpg',
    featured: true,
  ...
  },
  {
    ...
    image: '/images/card-navy-pnec.jpg',
  ...
  },
  {
    ...
    image: '/images/card-paf-logistics.jpg',
  ...
  },
  {
    ...
    image: '/images/card-air-defence.jpg',
  ...
  },
  {
    ...
    image: '/images/card-paf-accounts.jpg',
  ...
  },
  {
    ...
    image: '/images/card-paf-airmen.jpg',
  ...
  },
  {
    ...
    image: '/images/card-ssc-navy.jpg',
...
export const germanEposCourses: GermanEposCourse[] = [
  { id: 1, university: 'University of Bonn', program: 'MSc Agricultural Sciences & Resource Management (ARTS)', field: 'Agriculture', funding: '✅ EPOS Fully Funded', opening: 'August', closing: 'October', applyUrl: 'https://www.arts.uni-bonn.de', image: '/images/card-nust.jpg' },
  { id: 2, university: 'University of Bonn', program: 'MSc Global Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'December', closing: 'March', applyUrl: 'https://www.uni-bonn.de/en/studies/degree-programs', image: '/images/card-mdcat.jpg' },
  { id: 3, university: 'University of Freiburg', program: 'MSc Environmental Governance (MEG)', field: 'Environment & Sustainability', funding: '✅ EPOS Fully Funded', opening: 'July', closing: '15 October 2026', applyUrl: 'https://www.meg.uni-freiburg.de', image: '/images/card-ecat.jpg' },
  { id: 4, university: 'University of Freiburg', program: 'MSc Global Urban Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'December', closing: 'March', applyUrl: 'https://www.uni-freiburg.de', image: '/images/card-uet.jpg' },
  { id: 5, university: 'TH Köln', program: 'MSc Natural Resources Management and Development (NRM)', field: 'Sustainability', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '31 October 2026', applyUrl: 'https://www.th-koeln.de', image: '/images/card-pieas.jpg' },
  { id: 6, university: 'TH Köln', program: 'MSc Integrated Water Resources Management (IWRM)', field: 'Water Resources', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '31 October 2026', applyUrl: 'https://www.th-koeln.de', image: '/images/card-giki.jpg' },
  { id: 7, university: 'TH Köln', program: 'MSc Renewable Energy Management (REM)', field: 'Renewable Energy', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '31 October 2026', applyUrl: 'https://www.th-koeln.de', image: '/images/card-pma.jpg' },
  { id: 8, university: 'TU Darmstadt', program: 'MSc Tropical Hydrogeology and Environmental Engineering', field: 'Environmental Engineering', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '15 October 2026', applyUrl: 'https://www.trophee.tu-darmstadt.de', image: '/images/card-army-amc.jpg' },
  { id: 9, university: 'University of Bremen', program: 'MSc International Studies in Aquatic Tropical Ecology', field: 'Marine Biology', funding: '✅ EPOS Fully Funded', opening: 'September', closing: '15 January 2026', applyUrl: 'https://www.isatec.uni-bremen.de', image: '/images/card-civilian.jpg' },
  { id: 10, university: 'Charité–Berlin / Freie Uni', program: 'MSc International Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'October', closing: 'January', applyUrl: 'https://internationalhealth.charite.de', image: '/images/card-cts.jpg' },
  { id: 11, university: 'Heidelberg University', program: 'MSc International Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'October', closing: 'January', applyUrl: 'https://www.klinikum.uni-heidelberg.de/international-health', image: '/images/card-nts.jpg' },
  { id: 12, university: 'Munich IP Law Center', program: 'LL.M. Intellectual Property & Competition Law', field: 'Law & IP', funding: '✅ EPOS Fully Funded', opening: 'September', closing: '30 April 2026', applyUrl: 'https://www.miplc.de', image: '/images/card-ots.jpg' },
  { id: 13, university: 'University of Stuttgart', program: 'MSc Infrastructure Planning', field: 'Urban Planning', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '15 October 2026', applyUrl: 'https://www.uni-stuttgart.de', image: '/images/card-pts.jpg' },
  { id: 14, university: 'RPTU Kaiserslautern', program: 'MSc Regional Planning', field: 'Planning & Civil', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '15 October 2026', applyUrl: 'https://rptu.de/en', image: '/images/card-bpsc.jpg' },
  { id: 15, university: 'Ruhr University Bochum', program: 'MA Development Management', field: 'Development Studies', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '30 September 2026', applyUrl: 'https://www.development-research.org', image: '/images/card-gbpsc.jpg' },
  { id: 16, university: 'University of Leipzig', program: 'MBA Small Enterprise Promotion & Training (SEPT)', field: 'Entrepreneurship', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '01 October 2026', applyUrl: 'https://www.sept.uni-leipzig.de', image: '/images/card-ajkpsc.jpg' },
  { id: 17, university: 'HTW Berlin', program: 'MBA Building Sustainability', field: 'Sustainable Construction', funding: '✅ EPOS Fully Funded', opening: 'November', closing: 'March', applyUrl: 'https://www.htw-berlin.de', image: '/images/card-paf-education.jpg' },
  { id: 18, university: 'Hochschule Bonn-Rhein-Sieg', program: 'MBA CSR & NGO Management', field: 'NGO Management', funding: '✅ EPOS Fully Funded', opening: 'January', closing: 'May', applyUrl: 'https://www.h-brs.de', image: '/images/card-paf-it.jpg' },
  { id: 19, university: 'University of Hohenheim', program: 'MSc Agricultural Economics', field: 'Economics & Agri', funding: '✅ DAAD Funded', opening: 'August', closing: '15 December 2026', applyUrl: 'https://www.uni-hohenheim.de', image: '/images/card-paf-admin.jpg' },
  { id: 20, university: 'University of Passau', program: 'MA Development Studies', field: 'International Dev', funding: '✅ DAAD Funded', opening: 'April', closing: '30 June 2026', applyUrl: 'https://www.uni-passau.de/en', image: '/images/card-paf-logistics.jpg' }
]

export const pakistaniUniversities: PakistaniUniversity[] = [
  { id: 1, name: 'Lahore University of Management Sciences (LUMS)', city: 'Lahore', meritAid: '✅ Yes (Up to 50% for GMAT 700+/GRE equivalent)', needAid: '✅ Yes (Interest-free loan / tuition waivers)', graduateAid: 'Extensive Support', fields: 'Business, Economics, Computer Science, AI, Data Science, Law, Education, Public Policy', opening: 'November', closing: 'February', applyUrl: 'https://admissions.lums.edu.pk', image: '/images/card-nust.jpg' },
  { id: 2, name: 'Institute of Business Administration (IBA)', city: 'Karachi', meritAid: '✅ Highly Competitive Awards', needAid: '✅ Yes (Financial Aid & Donor Scholarships)', graduateAid: 'Full Support', fields: 'Business Admin, Accounting & Finance, Economics, AI, Computer Science, Public Policy', opening: 'April (Fall) / Oct (Spring)', closing: 'June (Fall) / Dec (Spring)', applyUrl: 'https://admissions.iba.edu.pk', image: '/images/card-ecat.jpg' },
  { id: 3, name: 'National University of Sciences & Tech (NUST)', city: 'Islamabad / Rawalpindi', meritAid: '✅ High CGPA / Entry Merit', needAid: '✅ NUST Need Based & Ehsaas / HEC', graduateAid: 'Research Assistantships', fields: 'Engineering, Computer Science, Aerospace, AI, Business, Natural Sciences, Architecture', opening: 'May', closing: 'July', applyUrl: 'https://nust.edu.pk/admissions', image: '/images/card-uet.jpg' },
  { id: 4, name: 'FAST - NUCES', city: 'Multiple Campuses', meritAid: '✅ Top position holders waivers', needAid: 'Limited Hardship Assistance', graduateAid: 'Merit Scholarships', fields: 'Computer Science, Software Engineering, AI, Cyber Security, Data Science, Electrical', opening: 'May', closing: 'July', applyUrl: 'https://admissions.nu.edu.pk', image: '/images/card-pieas.jpg' },
  { id: 5, name: 'University of Management & Technology (UMT)', city: 'Lahore / Sialkot', meritAid: '✅ CGPA based up to 60% Waiver (3.75+ = 60%)', needAid: '✅ Need assessment support', graduateAid: 'Extensive Graduate Aid', fields: 'Business Admin, Computer Science, AI, Engineering, Education, Psychology, Social Sciences', opening: 'May', closing: 'August', applyUrl: 'https://admissions.umt.edu.pk', image: '/images/card-giki.jpg' },
  { id: 6, name: 'University of Central Punjab (UCP)', city: 'Lahore', meritAid: '✅ Merit waivers on prior degree', needAid: '✅ Demonstrated hardship aid', graduateAid: 'Full Support', fields: 'Business Admin, Accounting, Computer Science, Pharmacy, Engineering, Law, Media', opening: 'May', closing: 'August', applyUrl: 'https://www.ucp.edu.pk/admissions', image: '/images/card-mdcat.jpg' },
  { id: 7, name: 'Superior University', city: 'Lahore', meritAid: '✅ Talent & Merit fee waivers', needAid: '✅ Need-based financial evaluation', graduateAid: 'Available', fields: 'Business Admin, AI, Engineering, Health Sciences, Pharmacy, Law, Education, Agriculture', opening: 'May', closing: 'August', applyUrl: 'https://admissions.superior.edu.pk', image: '/images/card-nust.jpg' },
  { id: 8, name: 'SZABIST', city: 'Karachi / Islamabad / Larkana', meritAid: '✅ Academic performance awards', needAid: '✅ Hardship & family income evaluation', graduateAid: 'Extensive', fields: 'Business Admin, AI, Data Science, Media Sciences, Public Health, Social Sciences, Education', opening: 'June (Fall) / Nov (Spring)', closing: 'August / January', applyUrl: 'https://www.szabist.edu.pk/admissions', image: '/images/card-ecat.jpg' },
  { id: 9, name: 'COMSATS University', city: 'Multiple Campuses', meritAid: '✅ High merit scholarships', needAid: 'Limited Financial Aid', graduateAid: 'Selected Programs', fields: 'Engineering, Computer Science, AI, Data Science, Biosciences, Environmental Sciences', opening: 'May / November', closing: 'July / January', applyUrl: 'https://admissions.comsats.edu.pk', image: '/images/card-uet.jpg' },
  { id: 10, name: 'Institute of Business Management (IoBM)', city: 'Karachi', meritAid: '✅ High CGPA concessions', needAid: '✅ Tuition fee support on hardship', graduateAid: 'Available', fields: 'Business Admin, Marketing, Supply Chain, Computer Science, Engineering, Economics, Media', opening: 'May', closing: 'July', applyUrl: 'https://admissions.iobm.edu.pk', image: '/images/card-pieas.jpg' },
  { id: 11, name: 'Bahria University', city: 'Islamabad / Karachi / Lahore', meritAid: '✅ Academic Excellence Awards', needAid: 'Limited Hardship', graduateAid: 'Yes', fields: 'Business Admin, Computer Science, AI, Engineering, Maritime Studies, Health Sciences, Psychology', opening: 'May / November', closing: 'July / January', applyUrl: 'https://bahria.edu.pk/admissions', image: '/images/card-giki.jpg' },
  { id: 12, name: 'University of Lahore (UOL)', city: 'Lahore', meritAid: '✅ High percentage / CGPA concessions', needAid: '✅ Need assessment support', graduateAid: 'Yes', fields: 'Medicine, Pharmacy, Engineering, Business Admin, AI, Law, Allied Health Sciences', opening: 'May', closing: 'August', applyUrl: 'https://admissions.uol.edu.pk', image: '/images/card-mdcat.jpg' },
  { id: 13, name: 'Riphah International University', city: 'Islamabad / Rawalpindi / Lahore', meritAid: '✅ Merit Scholarships', needAid: '✅ Financial Assistance', graduateAid: 'Available', fields: 'Health Sciences, Pharmacy, Rehabilitation, Business Admin, Computing, Psychology', opening: 'May / November', closing: 'July / January', applyUrl: 'https://admissions.riphah.edu.pk', image: '/images/card-nust.jpg' },
  { id: 14, name: 'Air University', city: 'Islamabad / Multan / Kamra', meritAid: '✅ Merit Awards', needAid: 'Limited Support', graduateAid: 'Available', fields: 'Aerospace Engineering, Cyber Security, AI, Electrical Engineering, Business, Avionics', opening: 'May / November', closing: 'July / January', applyUrl: 'https://portals.au.edu.pk/admissions', image: '/images/card-aeronautical.jpg' },
  { id: 15, name: 'Beaconhouse National University (BNU)', city: 'Lahore', meritAid: '✅ Academic Excellence', needAid: '✅ Demonstrated Need Support', graduateAid: 'Selected Programs', fields: 'Fine Arts, Architecture, Design, Media Studies, Liberal Arts, Psychology, Visual Arts', opening: 'May', closing: 'July', applyUrl: 'https://www.bnu.edu.pk/admissions', image: '/images/card-ecat.jpg' },
  { id: 16, name: 'Foundation University', city: 'Islamabad / Rawalpindi', meritAid: '✅ Tuition Concessions', needAid: 'Limited', graduateAid: 'Available', fields: 'Business Admin, Engineering, Computer Science, Pharmacy, Medical Sciences, Psychology', opening: 'May', closing: 'July', applyUrl: 'https://www.fui.edu.pk', image: '/images/card-uet.jpg' },
  { id: 17, name: 'DHA Suffa University', city: 'Karachi', meritAid: '✅ Merit Scholarships', needAid: 'Limited Support', graduateAid: 'Available', fields: 'Engineering, Computer Science, Software Engineering, AI, Business Administration, Architecture', opening: 'June', closing: 'August', applyUrl: 'https://www.dsu.edu.pk/admissions', image: '/images/card-pieas.jpg' },
  { id: 18, name: 'Habib University', city: 'Karachi', meritAid: '✅ Generous Merit Aid', needAid: '✅ Yohsin Need Scholarships', graduateAid: 'Limited Graduate Programs', fields: 'Computer Science, Electrical Engineering, Liberal Arts, Social Development & Policy', opening: 'November', closing: 'March', applyUrl: 'https://habib.edu.pk/admissions', image: '/images/card-giki.jpg' },
  { id: 19, name: 'Mohamad Ali Jinnah University (MAJU)', city: 'Karachi', meritAid: '✅ Merit Awards', needAid: '✅ Financial Assistance', graduateAid: 'Available', fields: 'Business Admin, Computer Science, AI, Software Engineering, Mathematics, Economics', opening: 'May', closing: 'August', applyUrl: 'https://jinnah.edu', image: '/images/card-mdcat.jpg' },
  { id: 20, name: 'Indus University', city: 'Karachi', meritAid: '✅ Merit Scholarships', needAid: '✅ Hardship Aid', graduateAid: 'Yes', fields: 'Engineering, Computer Science, AI, Business Admin, Media Sciences, Architecture', opening: 'May', closing: 'August', applyUrl: 'https://indus.edu.pk', image: '/images/card-nust.jpg' },
  { id: 21, name: 'Hamdard University', city: 'Karachi / Islamabad', meritAid: '✅ Merit Support', needAid: '✅ Need & Hardship Concessions', graduateAid: 'Yes', fields: 'Medicine, Pharmacy, Eastern Medicine, Engineering, Computer Science, Business Admin', opening: 'May', closing: 'July', applyUrl: 'https://hamdard.edu.pk/admissions', image: '/images/card-ecat.jpg' },
  { id: 22, name: 'GIFT University', city: 'Gujranwala', meritAid: '✅ Academic Awards', needAid: '✅ Need & Family Aid', graduateAid: 'Yes', fields: 'Business Admin, Computer Science, AI, Software Engineering, Law, Psychology, Education', opening: 'May', closing: 'August', applyUrl: 'https://gift.edu.pk', image: '/images/card-uet.jpg' },
  { id: 23, name: 'Minhaj University', city: 'Lahore', meritAid: '✅ Merit & Talent Aid', needAid: '✅ Financial Hardship Support', graduateAid: 'Yes', fields: 'Business Admin, AI, Computer Science, Islamic Studies, Education, Psychology, Media', opening: 'May', closing: 'August', applyUrl: 'https://mul.edu.pk/admissions', image: '/images/card-pieas.jpg' },
  { id: 24, name: 'National Textile University (NTU)', city: 'Faisalabad', meritAid: '✅ Top Performers', needAid: '✅ Need Based Support', graduateAid: 'Yes', fields: 'Textile Engineering, Materials Engineering, Fashion Design, Business Admin, Computer Science', opening: 'May', closing: 'July', applyUrl: 'https://ntu.edu.pk/admissions', image: '/images/card-giki.jpg' },
  { id: 25, name: 'Capital University of Science & Tech (CUST)', city: 'Islamabad', meritAid: '✅ Merit Concessions', needAid: 'Limited', graduateAid: 'Available', fields: 'Engineering, Computer Science, AI, Data Science, Mathematics, Business Admin, Psychology', opening: 'May', closing: 'July', applyUrl: 'https://cust.edu.pk/admissions', image: '/images/card-nust.jpg' }
]
