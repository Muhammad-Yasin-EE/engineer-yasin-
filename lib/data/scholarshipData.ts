...
export const internationalScholarships: ScholarshipItem[] = [
  {
    ...
    fields: 'almost all Master’s fields except Clinical Medicine. Popular: Public Policy, Education, Law, International Development, Business, Climate Change, Media, Technology, Economics.',
  ...
  },
  {
    ...
    fields: 'All academic disciplines except Clinical Medicine. Engineering, Computer Science, Artificial Intelligence, Education, Business, Economics, Public Admin, Environmental Sciences.',
    applyUrl: 'https://www.usefp.org/scholarships/fulbright-degree-program.cfm',
    featured: true,
    notes: 'GRE General Test required for most applicants. Administered in Pakistan directly by USEFP.'
  },
  {
    id: 'erasmus',
    name: 'Erasmus Mundus Joint Masters (EMJM)',
    country: 'Europe (Multiple Countries) 🇪🇺',
    funding: '✅ Fully Funded (€1,400/mo Stipend + Full Tuition + Travel & Visa)',
    eligible: '✅ Open to Pakistanis (Category A)',
    openingDate: 'October annually',
    closingDate: 'December – February (varies by program)',
    fields: 'Engineering, Artificial Intelligence, Computer Science, Data Science, Renewable Energy, Public Policy, Education, Business, Economics, Environmental Sciences.',
  ...
  },
  {
    ...
    country: 'Germany 🇩🇪',
    funding: '✅ Fully Funded (€934/mo Master’s + Full Tuition + Travel Aid)',
    eligible: '✅ Pakistan & Developing Nations',
    openingDate: 'August – September',
    closingDate: 'October – December (program specific)',
    fields: 'Economics, Public Policy, Development Studies, Engineering, Environmental Sciences, Public Health, Agriculture, Education, Urban Planning, Water Resources, Renewable Energy.',
  ...
  },
  {
    ...
    country: 'Hungary 🇭🇺',
    funding: '✅ Fully Funded (Tuition + Stipend + Housing Support + Medical)',
  ...
  },
  {
    ...
    fields: 'Engineering, Health Sciences, Medicine, Islamic Studies, Social Sciences, International Relations, Business, Agriculture, Architecture, Education, Arts.',
  ...
  },
  {
    ...
    fields: 'Engineering, Computer Science, Robotics, Artificial Intelligence, Natural Sciences, Agriculture, Economics, Business, Education, Environmental Sciences.',
  ...
  },
  {
    ...
    fields: 'Engineering, ICT, Artificial Intelligence, Business, Economics, International Studies, Natural Sciences, Biotechnology, Education, Social Sciences.',
  ...
  },
  {
    ...
    fields: 'Engineering, Information Technology, Artificial Intelligence, Medicine, Agriculture, Business, Economics, Natural Sciences, Environmental Sciences.',
  ...
  },
  {
    ...
    fields: 'Sustainability, Environmental Sciences, Climate Change, Public Admin, Human Rights, Business, Innovation, Engineering, IT, Social Sciences.',
  ...
  },
  {
    ...
    country: 'Australia 🇦🇺',
    funding: '✅ Fully Funded (Tuition + Return Airfare + Living Allowance + Health)',
    eligible: '✅ Pakistani Citizens',
    openingDate: 'February annually',
    closingDate: 'April / May',
    fields: 'Education, Public Policy, Governance, Gender Studies, Agriculture, Climate Change, Environmental Management, Public Health, Engineering, Water Resources.',
  ...
  },
  {
    ...
    country: 'United Kingdom 🇬🇧',
    funding: '✅ Fully Funded (Tuition + Airfare + Monthly Stipend + Thesis Grant)',
    eligible: '✅ Pakistani Citizens & Commonwealth Nations',
    openingDate: 'September',
    closingDate: 'October annually',
    fields: 'Education, Public Health, Engineering, Environmental Sciences, Agriculture, Climate Change, Development Studies, Economics, Public Policy, STEM.',
  ...
  },
  {
    ...
    fields: 'Business & Management, Engineering, Computer Science, Artificial Intelligence, Law, Education, Public Health, Creative Arts, Environmental Sciences.',
  ...
  {
    id: 'russian-gov',
    name: 'Russian Government Scholarship (Open Doors / Russian Min of Science)',
    country: 'Russia 🇷🇺',
    funding: '✅ Full Tuition Waiver + Monthly Stipend + University Placement',
    eligible: '✅ Pakistani Citizens',
    openingDate: 'September',
    closingDate: 'December annually',
    fields: 'Engineering, Medicine, Computer Science, Mathematics, Physics, Aerospace, Natural Sciences, Agriculture, Economics, Business, Humanities.',
  ...
  },
  {
    ...
    fields: 'Engineering, Energy Studies, Information Technology, Economics, Business Admin, International Relations, Agriculture, Medicine, Public Admin.',
...
export const germanEposCourses: GermanEposCourse[] = [
  { id: 1, university: 'University of Bonn', program: 'MSc Agricultural Sciences and Resource Management in the Tropics (ARTS)', field: 'Agriculture', funding: '✅ EPOS Fully Funded', opening: 'August', closing: 'October', applyUrl: 'https://www.arts.uni-bonn.de' },
  { id: 2, university: 'University of Bonn', program: 'MSc Global Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'December', closing: 'March', applyUrl: 'https://www.uni-bonn.de/en/studies/degree-programs' },
  { id: 3, university: 'University of Freiburg', program: 'MSc Environmental Governance (MEG)', field: 'Environment & Sustainability', funding: '✅ EPOS Fully Funded', opening: 'July', closing: '15 October 2026', applyUrl: 'https://www.meg.uni-freiburg.de' },
  { id: 4, university: 'University of Freiburg', program: 'MSc Global Urban Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'December', closing: 'March', applyUrl: 'https://www.uni-freiburg.de' },
  { id: 5, university: 'TH Köln', program: 'MSc Natural Resources Management and Development (NRM)', field: 'Sustainability', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '31 October 2026', applyUrl: 'https://www.th-koeln.de' },
  { id: 6, university: 'TH Köln', program: 'MSc Integrated Water Resources Management (IWRM)', field: 'Water Resources', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '31 October 2026', applyUrl: 'https://www.th-koeln.de' },
  { id: 7, university: 'TH Köln', program: 'MSc Renewable Energy Management (REM)', field: 'Renewable Energy', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '31 October 2026', applyUrl: 'https://www.th-koeln.de' },
  { id: 8, university: 'TU Darmstadt', program: 'MSc Tropical Hydrogeology and Environmental Engineering (TropHEE)', field: 'Environmental Engineering', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '15 October 2026', applyUrl: 'https://www.trophee.tu-darmstadt.de' },
  { id: 9, university: 'University of Bremen', program: 'MSc International Studies in Aquatic Tropical Ecology (ISATEC)', field: 'Marine Biology', funding: '✅ EPOS Fully Funded', opening: 'September', closing: '15 January 2026', applyUrl: 'https://www.isatec.uni-bremen.de' },
  { id: 10, university: 'Charité–Berlin / Freie Uni', program: 'MSc International Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'October', closing: 'January', applyUrl: 'https://internationalhealth.charite.de' },
  { id: 11, university: 'Heidelberg University', program: 'MSc International Health', field: 'Public Health', funding: '✅ EPOS Fully Funded', opening: 'October', closing: 'January', applyUrl: 'https://www.klinikum.uni-heidelberg.de/international-health' },
  { id: 12, university: 'Munich Intellectual Property Law Center', program: 'LL.M. Intellectual Property and Competition Law', field: 'Law & IP', funding: '✅ EPOS Fully Funded', opening: 'September', closing: '30 April 2026', applyUrl: 'https://www.miplc.de' },
  { id: 13, university: 'University of Stuttgart', program: 'MSc Infrastructure Planning', field: 'Urban Planning', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '15 October 2026', applyUrl: 'https://www.uni-stuttgart.de' },
  { id: 14, university: 'University of Kaiserslautern-Landau (RPTU)', program: 'MSc Regional Planning', field: 'Planning & Civil', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '15 October 2026', applyUrl: 'https://rptu.de/en' },
  { id: 15, university: 'Ruhr University Bochum', program: 'MA Development Management', field: 'Development Studies', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '30 September 2026', applyUrl: 'https://www.development-research.org' },
  { id: 16, university: 'University of Leipzig', program: 'MBA Small Enterprise Promotion & Training (SEPT)', field: 'Entrepreneurship', funding: '✅ EPOS Fully Funded', opening: 'August', closing: '01 October 2026', applyUrl: 'https://www.sept.uni-leipzig.de' },
  { id: 17, university: 'HTW Berlin', program: 'MBA Building Sustainability', field: 'Sustainable Construction', funding: '✅ EPOS Fully Funded', opening: 'November', closing: 'March', applyUrl: 'https://www.htw-berlin.de' },
  { id: 18, university: 'Hochschule Bonn-Rhein-Sieg', program: 'MBA CSR & NGO Management', field: 'NGO Management', funding: '✅ EPOS Fully Funded', opening: 'January', closing: 'May', applyUrl: 'https://www.h-brs.de' },
  { id: 19, university: 'University of Hohenheim', program: 'MSc Agricultural Economics', field: 'Economics & Agri', funding: '✅ DAAD Funded', opening: 'August', closing: '15 December 2026', applyUrl: 'https://www.uni-hohenheim.de' },
  { id: 20, university: 'University of Passau', program: 'MA Development Studies', field: 'International Dev', funding: '✅ DAAD Funded', opening: 'April', closing: '30 June 2026', applyUrl: 'https://www.uni-passau.de/en' }
]

export const pakistaniUniversities: PakistaniUniversity[] = [
  { id: 1, name: 'Lahore University of Management Sciences (LUMS)', city: 'Lahore', meritAid: '✅ Yes (Up to 50% for GMAT 700+/GRE equivalent)', needAid: '✅ Yes (Interest-free loan / tuition waivers)', graduateAid: 'Extensive Support', fields: 'Business, Economics, Computer Science, AI, Data Science, Law, Education, Public Policy', opening: 'November', closing: 'February', applyUrl: 'https://admissions.lums.edu.pk' },
  ...
  { id: 3, name: 'National University of Sciences & Tech (NUST)', city: 'Islamabad / Rawalpindi', meritAid: '✅ High CGPA / Entry Merit', needAid: '✅ NUST Need Based & Ehsaas / HEC', graduateAid: 'Research Assistantships', fields: 'Engineering, Computer Science, Aerospace, AI, Business, Natural Sciences, Architecture', opening: 'May', closing: 'July', applyUrl: 'https://nust.edu.pk/admissions' },
  { id: 4, name: 'FAST - NUCES', city: 'Multiple Campuses', meritAid: '✅ Top position holders waivers', needAid: 'Limited Hardship Assistance', graduateAid: 'Merit Scholarships', fields: 'Computer Science, Software Engineering, AI, Cyber Security, Data Science, Electrical', opening: 'May', closing: 'July', applyUrl: 'https://admissions.nu.edu.pk' },
  { id: 5, name: 'University of Management & Technology (UMT)', city: 'Lahore / Sialkot', meritAid: '✅ CGPA based up to 60% Waiver (3.75+ = 60%)', needAid: '✅ Need assessment support', graduateAid: 'Extensive Graduate Aid', fields: 'Business Admin, Computer Science, AI, Engineering, Education, Psychology, Social Sciences', opening: 'May', closing: 'August', applyUrl: 'https://admissions.umt.edu.pk' },
  { id: 6, name: 'University of Central Punjab (UCP)', city: 'Lahore', meritAid: '✅ Merit waivers on prior degree', needAid: '✅ Demonstrated hardship aid', graduateAid: 'Full Support', fields: 'Business Admin, Accounting, Computer Science, Pharmacy, Engineering, Law, Media', opening: 'May', closing: 'August', applyUrl: 'https://www.ucp.edu.pk/admissions' },
  { id: 7, name: 'Superior University', city: 'Lahore', meritAid: '✅ Talent & Merit fee waivers', needAid: '✅ Need-based financial evaluation', graduateAid: 'Available', fields: 'Business Admin, AI, Engineering, Health Sciences, Pharmacy, Law, Education, Agriculture', opening: 'May', closing: 'August', applyUrl: 'https://admissions.superior.edu.pk' },
  { id: 8, name: 'SZABIST', city: 'Karachi / Islamabad / Larkana', meritAid: '✅ Academic performance awards', needAid: '✅ Hardship & family income evaluation', graduateAid: 'Extensive', fields: 'Business Admin, AI, Data Science, Media Sciences, Public Health, Social Sciences, Education', opening: 'June (Fall) / Nov (Spring)', closing: 'August / January', applyUrl: 'https://www.szabist.edu.pk/admissions' },
  { id: 9, name: 'COMSATS University', city: 'Multiple Campuses', meritAid: '✅ High merit scholarships', needAid: 'Limited Financial Aid', graduateAid: 'Selected Programs', fields: 'Engineering, Computer Science, AI, Data Science, Biosciences, Environmental Sciences', opening: 'May / November', closing: 'July / January', applyUrl: 'https://admissions.comsats.edu.pk' },
  { id: 10, name: 'Institute of Business Management (IoBM)', city: 'Karachi', meritAid: '✅ High CGPA concessions', needAid: '✅ Tuition fee support on hardship', graduateAid: 'Available', fields: 'Business Admin, Marketing, Supply Chain, Computer Science, Engineering, Economics, Media', opening: 'May', closing: 'July', applyUrl: 'https://admissions.iobm.edu.pk' },
  { id: 11, name: 'Bahria University', city: 'Islamabad / Karachi / Lahore', meritAid: '✅ Academic Excellence Awards', needAid: 'Limited Hardship', graduateAid: 'Yes', fields: 'Business Admin, Computer Science, AI, Engineering, Maritime Studies, Health Sciences, Psychology', opening: 'May / November', closing: 'July / January', applyUrl: 'https://bahria.edu.pk/admissions' },
  { id: 12, name: 'University of Lahore (UOL)', city: 'Lahore', meritAid: '✅ High percentage / CGPA concessions', needAid: '✅ Need assessment support', graduateAid: 'Yes', fields: 'Medicine, Pharmacy, Engineering, Business Admin, AI, Law, Allied Health Sciences', opening: 'May', closing: 'August', applyUrl: 'https://admissions.uol.edu.pk' },
  { id: 13, name: 'Riphah International University', city: 'Islamabad / Rawalpindi / Lahore', meritAid: '✅ Merit Scholarships', needAid: '✅ Financial Assistance', graduateAid: 'Available', fields: 'Health Sciences, Pharmacy, Rehabilitation, Business Admin, Computing, Psychology', opening: 'May / November', closing: 'July / January', applyUrl: 'https://admissions.riphah.edu.pk' },
  { id: 14, name: 'Air University', city: 'Islamabad / Multan / Kamra', meritAid: '✅ Merit Awards', needAid: 'Limited Support', graduateAid: 'Available', fields: 'Aerospace Engineering, Cyber Security, AI, Electrical Engineering, Business, Avionics', opening: 'May / November', closing: 'July / January', applyUrl: 'https://portals.au.edu.pk/admissions' },
  { id: 15, name: 'Beaconhouse National University (BNU)', city: 'Lahore', meritAid: '✅ Academic Excellence', needAid: '✅ Demonstrated Need Support', graduateAid: 'Selected Programs', fields: 'Fine Arts, Architecture, Design, Media Studies, Liberal Arts, Psychology, Visual Arts', opening: 'May', closing: 'July', applyUrl: 'https://www.bnu.edu.pk/admissions' },
  { id: 16, name: 'Foundation University', city: 'Islamabad / Rawalpindi', meritAid: '✅ Tuition Concessions', needAid: 'Limited', graduateAid: 'Available', fields: 'Business Admin, Engineering, Computer Science, Pharmacy, Medical Sciences, Psychology', opening: 'May', closing: 'July', applyUrl: 'https://www.fui.edu.pk' },
  { id: 17, name: 'DHA Suffa University', city: 'Karachi', meritAid: '✅ Merit Scholarships', needAid: 'Limited Support', graduateAid: 'Available', fields: 'Engineering, Computer Science, Software Engineering, AI, Business Administration, Architecture', opening: 'June', closing: 'August', applyUrl: 'https://www.dsu.edu.pk/admissions' },
  { id: 18, name: 'Habib University', city: 'Karachi', meritAid: '✅ Generous Merit Aid', needAid: '✅ Yohsin Need Scholarships', graduateAid: 'Limited Graduate Programs', fields: 'Computer Science, Electrical Engineering, Liberal Arts, Social Development & Policy', opening: 'November', closing: 'March', applyUrl: 'https://habib.edu.pk/admissions' },
  { id: 19, name: 'Mohamad Ali Jinnah University (MAJU)', city: 'Karachi', meritAid: '✅ Merit Awards', needAid: '✅ Financial Assistance', graduateAid: 'Available', fields: 'Business Admin, Computer Science, AI, Software Engineering, Mathematics, Economics', opening: 'May', closing: 'August', applyUrl: 'https://jinnah.edu' },
  { id: 20, name: 'Indus University', city: 'Karachi', meritAid: '✅ Merit Scholarships', needAid: '✅ Hardship Aid', graduateAid: 'Yes', fields: 'Engineering, Computer Science, AI, Business Admin, Media Sciences, Architecture', opening: 'May', closing: 'August', applyUrl: 'https://indus.edu.pk' },
  { id: 21, name: 'Hamdard University', city: 'Karachi / Islamabad', meritAid: '✅ Merit Support', needAid: '✅ Need & Hardship Concessions', graduateAid: 'Yes', fields: 'Medicine, Pharmacy, Eastern Medicine, Engineering, Computer Science, Business Admin', opening: 'May', closing: 'July', applyUrl: 'https://hamdard.edu.pk/admissions' },
  { id: 22, name: 'GIFT University', city: 'Gujranwala', meritAid: '✅ Academic Awards', needAid: '✅ Need & Family Aid', graduateAid: 'Yes', fields: 'Business Admin, Computer Science, AI, Software Engineering, Law, Psychology, Education', opening: 'May', closing: 'August', applyUrl: 'https://gift.edu.pk' },
  { id: 23, name: 'Minhaj University', city: 'Lahore', meritAid: '✅ Merit & Talent Aid', needAid: '✅ Financial Hardship Support', graduateAid: 'Yes', fields: 'Business Admin, AI, Computer Science, Islamic Studies, Education, Psychology, Media', opening: 'May', closing: 'August', applyUrl: 'https://mul.edu.pk/admissions' },
  { id: 24, name: 'National Textile University (NTU)', city: 'Faisalabad', meritAid: '✅ Top Performers', needAid: '✅ Need Based Support', graduateAid: 'Yes', fields: 'Textile Engineering, Materials Engineering, Fashion Design, Business Admin, Computer Science', opening: 'May', closing: 'July', applyUrl: 'https://ntu.edu.pk/admissions' },
  { id: 25, name: 'Capital University of Science & Tech (CUST)', city: 'Islamabad', meritAid: '✅ Merit Concessions', needAid: 'Limited', graduateAid: 'Available', fields: 'Engineering, Computer Science, AI, Data Science, Mathematics, Business Admin, Psychology', opening: 'May', closing: 'July', applyUrl: 'https://cust.edu.pk/admissions' }
]
